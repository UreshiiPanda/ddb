/* 
defines custom behavior for the "reload db" function and
for the Users page
*/
...
function bind_index() {
    /*
       JS Logic for index.html which binds user clicks for 
       selecting a user from the dropdown and for insert user button
     */
    ...
    insert_usr_btn.addEventListener("click", (e) =>
    {
        ...
        // Pre-flight check make sure every field has something
        ...
        // Check that the email form has valid text
