"""
    This Flask/Python file handles route for two intersection
    tables in the DB: Character_has_Spells and Character_has_Abilities
...
def spells_abilities_page():
    ...
    if request.method == "GET":
        ...
        # handle different user requests based on which button was clicked
